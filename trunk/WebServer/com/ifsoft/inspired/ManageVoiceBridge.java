...
{
	public ManageVoiceBridge(InspiredComponent InspiredComponent)
	{
		super(InspiredComponent);
	}
	...
	public Element execute(SessionData data, Element newCommand, Element oldCommand)
	{
		...
		try {
			...
			String errorMessage = this.getInspiredComponent().manageVoiceBridge(newCommand, userJID, actionList);
