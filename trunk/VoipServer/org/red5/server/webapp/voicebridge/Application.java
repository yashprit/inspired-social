...
*/
    ...
    private static void sendCallEventNotification(CallEvent callEvent, String monitorName, String jid, BridgeParticipant bp)
    {
		...
		String myEvent = CallEvent.getEventString(callEvent.getEvent());
			...
			iq.setFrom("inspired." + JiveGlobals.getProperty("xmpp.domain", XMPPServer.getInstance().getServerInfo().getHostname()));
			iq.setTo("pubsub." + JiveGlobals.getProperty("xmpp.domain", XMPPServer.getInstance().getServerInfo().getHostname()));
