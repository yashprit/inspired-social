...
public class ResampleUtils {
    ...
    public static byte[] resample( float sampleRateFactor, int[] s2 ) {

        int o1 = 0;
        int l1 = s2.length;

        float[] s1 = new float[ l1 ];
    ...
    public static byte[] float2byte(float[] tmp ) {

        byte[] outSample = new byte[ tmp.length * 2 ];
        int pos = 0;
