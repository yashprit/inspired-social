...
public class PHP2Java extends AbstractQuercusModule
{
	...
	private void createRoom(String roomName)
	{
		...
		try
		{
			...
			{
				MUCRoom room = XMPPServer.getInstance().getMultiUserChatManager().getMultiUserChatService("conference").getChatRoom(roomName, new JID("admin@"+domainName));
			...
			Log.error("createRoom exception " + e);
		}
	}
...
/*
        ...
        field.setType(FormField.TYPE_TEXT_SINGLE);
        field.addValue(String.valueOf(room.getID()));
        dataForm.addField(field);
*/
