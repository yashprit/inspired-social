...
function chatMini(type, xid, nick, hash, pwd, show_pane) 
{
	...
	if(!exists(current)) {
		...
		{
		 	phonConf = '<td><a title="Conference Call" href="javascript:doPhono(&quot;sip:' + getXIDNick(xid) + '@' + MINI_DOMAIN + '&quot;)"><img height="16" src="' + JAPPIX_STATIC + 'php/get.php?t=img&amp;f=others/telephone.jpg"/></a></td>'			
		}
		...
		html += '</div>' + 
			...
			'<div class="jm_received-messages" id="received-' + hash + '"></div>' + 
				'<form action="#" method="post">' + 
					...
					'       <td><a title="Desktop Screen Share" href="javascript:screenShare(&quot;' + xid + '&quot;,&quot;' + type + '&quot;)"><img src="' + JAPPIX_STATIC + 'php/get.php?t=img&amp;f=others/screen_share.gif"/></a></td>' + 					
					phonConf +			
					'</tr></table></div>' +
