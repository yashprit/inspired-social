=== Group Documents ===
Contributors: Peter Anselmo revised by Lena Stergatu (stergatu@cti.gr) since version 0.4 with additional bug fixes by Keeble Smith Ltd (http://keeblesmith.com)
...
==Changelog==
See history.txt for newer version changelog
...
- Fix some  style issues and js script position 
- Added some localized strings


= 0.4.1 =
- Bug Fix. By Lena Stergatu stergatu@cti.gr


= 0.4 =
- Added WP3.3 Compatibility.  By Lena Stergatu stergatu@cti.gr
