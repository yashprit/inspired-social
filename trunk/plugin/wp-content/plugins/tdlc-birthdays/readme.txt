...
This simple Buddypress Widget uses a Birthday field from Buddypress extended profile to display a list of upcoming birthdays of either all BP users or the connected user's friends only. English, French, German, Hungarian, Italian, Japanese, Polish, Russian and Spanish languages available.

== Description ==

*WARNING: Since version 0.2, the plugin is designed for Buddypress 1.2. If you use an earlier version of Buddypress, please use version 0.1.7 : http://downloads.wordpress.org/plugin/tdlc-birthdays.0.1.7.zip*
