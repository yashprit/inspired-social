...
//	
            ...
            foreach ($document_list as $item) {
                ...
                if ($instance['group_filter']) {
                    echo '<li style="list-style-type: none; 
                            background-image: url(\'' . $document->get_icon() . '\'); 
                            background-repeat: no-repeat; "><a href="' . $document->get_url() . '">' . esc_attr($document->name) . '</a></li>';
                } else {
                    echo '<li style="list-style-type: none; 
                            background-image: url(\'' . $document->get_icon() . '\'); 
    ...
    function form($instance) {
        ...
        <?php if (BP_GROUP_DOCUMENTS_WIDGET_GROUP_FILTER) { ?>
            ...
            <p><input type="checkbox" id="<?php echo $this->get_field_id('featured'); ?>" name="<?php echo $this->get_field_name('featured'); ?>" value="1" <?php if ($featured)
