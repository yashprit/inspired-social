...
/*@since 0.4.3
 *  Add BP Groups Documents activity types to the activity filter dropdown
 */
/**
	 * Adds bp_group_documents options to activity filter dropdowns
	 *
	...
	function activity_filter_options() {
		...
		<option value="added_group_document"><?php _e( 'Show New Group Documents', 'bp-group-documents' ); ?></option>
		<option value="edited_group_document"><?php _e( 'Show Group Documents Edits', 'bp-group-documents' ); ?></option>
		<?php
	}
