...
class IntegrityAttributeImpl extends GenericAttribute implements IntegrityAttribute {
    ...
    public IntegrityAttributeImpl(String password) {
        this.type = AttributeType.MESSAGE_INTEGRITY;
        Logger.getAnonymousLogger().log(Level.FINER, "Forming Credentials: {0}", new Object[]{password});
        this.credentials = computeMD5(password);
        this.length = 20;
    }
