...
public class InspiredComponent extends AbstractComponent implements InspiredConstants {

	private ComponentManager componentManager;
	private JID componentJID = null;
	public InspiredPlugin plugin;
...
//-------------------------------------------------------
	...
	public InspiredComponent(InspiredPlugin plugin)
	{
        super(16, 1000, true);

		Log.info( "InspiredComponent");
   ...
   @Override public IQ handleDiscoInfo(IQ iq)
    {
		...
		identity.addAttribute("name", "Inspired");
